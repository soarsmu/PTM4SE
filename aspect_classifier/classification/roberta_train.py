from data.dataloader import get_train_valid_Roberta_undersample
...
if __name__ == "__main__":
      ...
      # aspects = ['Performance','Usability','Security','Community','Compatibility']
      ...
      for aspect in aspects:
            ...
            for x1,x2 in kf.split(X,y_digit):
                  ...
                  for samplestrategy in undersample:
                        ...
                        train_iter, val_iter, test_iter = get_train_valid_Roberta_undersample(samplestrategy,X,y_digit,aspect,train_stratified,val_stratified,x2,tokenizer, max_seq_lenght=160)

                        for learn_rate in learn_rate_list:

                              try:

                                    model = RobertaForSequenceClassification.from_pretrained(PRE_TRAINED_MODEL_NAME, num_labels = 2)
                              except:
                                    time.sleep(15)
                                    model = RobertaForSequenceClassification.from_pretrained(PRE_TRAINED_MODEL_NAME, num_labels = 2)
                              ...
                              for epoch in range(EPOCHS):
                                    ...
                                    if val_F_1 > best_epoch_F1:
                                          ...
                                          path = '//model/'+aspect+str(samplestrategy)+str(count)+'Roberta_model.bin'
